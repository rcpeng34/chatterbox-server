...
we could have called it anything (myServer, blahblah, etc.). The function we pass it (handler)
will, unsurprisingly, handle all incoming requests. (ps: 'handler' is in the 'request-handler' file).
